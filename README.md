...
- `urls.db`: Inserts the scraped data into the SQLite database into `urls.db`.
...
4. Run the text extraction script to process the extracted data and calculate the frequency of strings:
