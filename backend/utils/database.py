"""
Database utilities and connection management with PostgreSQL support
"""
...
def get_db_connection():
    """Get database connection with context manager (PostgreSQL or SQLite)"""
...
def init_database():
    ...
    with get_db_connection() as conn:
        ...
        conn.commit()
        print(f"Database initialized with {count if 'count' in locals() else cursor.rowcount} sample records")
